...
namespace QuantaQuirk\Filesystem;

use Closure;
use QuantaQuirk\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use QuantaQuirk\Contracts\Filesystem\Filesystem as FilesystemContract;
use QuantaQuirk\Http\File;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @param  \QuantaQuirk\Http\File|\QuantaQuirk\Http\UploadedFile|string  $path
     * @param  \QuantaQuirk\Http\File|\QuantaQuirk\Http\UploadedFile|string|array|null  $file
     * @param  mixed  $options
     * @return string|false
     */
